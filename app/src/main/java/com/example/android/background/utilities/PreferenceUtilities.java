...
public final class PreferenceUtilities {
    ...
    public static String getResponseData(Context context){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String data = prefs.getString(FETCHED_DATA,DEFAULT_TEXT);
//        data = data + s;
//        PreferenceUtilities.setResponseData(context, data);
        return data;
    }

    synchronized private static void setResponseData(Context context, String data) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(FETCHED_DATA, data);
        editor.apply();
    }

    synchronized public static void changeData(Context context,String s) {
        String data =  s;
        PreferenceUtilities.setResponseData(context, data);
